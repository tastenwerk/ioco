...
function migrateVersions( req, res, next ){
  ...
  if( 'version' === 'version' ){
    var tr = getTranslationsStr();
    var genFileName =  __dirname + '../../public/locales/de/gen_translation.json';
    fs.writeFile( genFileName, tr, function( err ){

      console.log('written file ', genFileName );
      next();
    } );
  }
