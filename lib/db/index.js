...
function ConnectionHandler( dbPathUri ){
  ...
  this.ObjectId = this.adapter.ObjectId;
  this.findAnyWithUser = this.adapter.findAnyWithUser;
  this.findAnyByIdWithUser = this.adapter.findAnyByIdWithUser;
  this.firstAnyWithUser = this.adapter.firstAnyWithUser;
